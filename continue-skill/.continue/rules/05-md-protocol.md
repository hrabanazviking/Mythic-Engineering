---
name: mythic-engineering-md-protocol
description: Mythic Engineering MD Protocol — the required project documentation structure (the "scrolls") and recommended repository layout. Pull this when setting up a new project, auditing whether an existing project follows the protocol, or asked about which docs a Mythic Engineering project should have.
alwaysApply: false
---
